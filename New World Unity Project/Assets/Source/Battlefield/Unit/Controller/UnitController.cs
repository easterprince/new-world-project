    ...
    public partial class UnitController : MonoBehaviour, IParentModule<UnitController> {
        ...
        public static UnitController BuildUnit(Transform parent, UnitTemplate template) {
            ...
            unitController.ProcessGameActions(new GameAction[] {
                new AbilityAttachment(unitController, new BasicMotion(2)),
                new AbilityAttachment(unitController, new BasicAttack(20, 2))
            }, true);
        ...
        private void Update() {
            ...
            if (durability != null) {
                durability.Update(ownPassport, out ConditionChange forceCondition);
            ...
            if (intelligence != null) {
                intelligence.Act(ownPassport, out ConditionCancellation cancelCondition, out AbilityUsage useAbility);
